...
from src.models.components.efficientnet_encoder import EfficientNetEncoder
...
class EffNetBiFPN(nn.Module):
    ...
    def __init__(self):
        ...
        self.final_layer = nn.Sequential(nn.Conv2d(in_channels=64 * 3, out_channels=1, kernel_size=3, padding=1))
